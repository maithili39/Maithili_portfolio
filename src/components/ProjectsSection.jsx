...
const projects = [
  {
    ...
    techStack: ['Python', 'FastAPI', 'React.js', 'TigerGraph'],
  ...
  },
  {
    ...
    techStack: ['Python', 'FastAPI', 'PostgreSQL', 'ChromaDB', 'React.js', 'Tailwind CSS'],
  ...
  },
  {
    ...
    techStack: ['React.js', 'Node.js', 'Express.js', 'MongoDB', 'Python', 'FastAPI'],
  ...
  },
  {
    ...
    techStack: ['Python', 'ChromaDB', 'Streamlit', 'NumPy', 'Hugging Face Spaces'],
